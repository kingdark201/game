...
const Game = () => {
   ...
   const saveScore = () => {
      ...
      if (!isScoreSaved) {
         ...
         scores.push({ name: playerName, score, level, mode, number_question: endIndex - startIndex });
      ...
      <div className="game-container">
         {isSelectingRange ? (
            ...
            <>
               ...
               {randomImage && <img src={randomImage} alt="Random" className="img-random" onClick={(e)=>handleImage(e)} />}
